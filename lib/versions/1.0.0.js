...
exports.parseCapabilities = function(xmlDoc) {
    ...
    var capabilities = mapper.buildObject(xmlDoc, 'Main');

    if (capabilities.service && _.isString(capabilities.service.keywords)) {
    ...
    if (capabilities.featureTypes) {
        capabilities.featureTypes.forEach(function(featureType) {
            if (featureType.keywords && _.isString(featureType.keywords)) {
